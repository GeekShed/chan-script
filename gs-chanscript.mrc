...
on 1:START:{
  ...
  set %gs.hn.help this channel is for GeekShed related help only. If you need help with your computer, please visit #247fixes, #atribune, #geekstogo, #livechat, #ethernet, #bleepingcomputer, or #chris
